...
function formCreats(args,files111){
  ...
  for(var a of args){
    if(a.argsType=='textarea'){
      ...
      rule.push(b)
    }else if(a.argsType=='fileTextArea'){
      var bb={}
      bb.type='radio'
      bb.title='输入或选择文件'
      var r=a.id.toString()
      ...
      f.name='text'
      rule.push(f)
    }else if(a.argsType=='file_text-R' || a.argsType=='file_text-RW' || a.argsType=='file_text-W' || a.argsType=='file_binary-R' || a.argsType=='file_binary-RW' || a.argsType=='file_binary-W'){
      var f={}
      f.type='input'
      f.title=a.argsLabel
      f.field=a.id.toString()
      ...
      f.props.placeholder=a.argsDesc
      rule.push(f)
    }else if(a.argsType=='file_folder-RW'){
      var f={}
      f.type='select'
      f.title=a.argsLabel
      f.value=a.defaultValue
      ...
      rule.push(f)
    }else if(a.argsType=='file_folder-W'){
      var f={}
      f.type='select'
      f.title=a.argsLabel
      f.value=a.defaultValue
      ...
      rule.push(f)
    }else if(a.argsType=='file_folder-R'){
      var f={}
      f.type='select'
      f.title=a.argsLabel
      f.value=a.defaultValue
      ...
      rule.push(f)
    }else if(a.argsType=='file_Multiple-text' || a.argsType=='file_Multiple-binary'){
      var f={}
      f.type='input'
      f.title=a.argsLabel
      f.field=a.id.toString()
